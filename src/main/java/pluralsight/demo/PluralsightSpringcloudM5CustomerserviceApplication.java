...
public class PluralsightSpringcloudM5CustomerserviceApplication {
	...
	public @ResponseBody String getCustomer(@PathVariable Integer cid) {
		...
		ResponseEntity<String> contact = webTemplate.getForEntity("http://localhost:9081/fastpass/customer/"+cid+"/contactdetails", String.class);
		ResponseEntity<String> vehicle = webTemplate.getForEntity("http://localhost:9082/fastpass/customer/"+cid+"/vehicledetails", String.class);
